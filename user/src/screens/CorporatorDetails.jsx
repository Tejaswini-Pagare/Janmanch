...
const CorporatorDetails = () => {
  ...
  return (
    ...
    <div className="p-6 font-sans max-w-6xl mx-auto">
      ...
      <div className="border rounded-lg p-6 bg-gray-100 shadow-lg mb-12">
        <h2 className="text-2xl font-bold text-center mb-6 text-gray-800 border-b-2 border-slate-950 hover:scale-105 transition-transform shadow-lg rounded-lg pb-3">Corporator Details</h2>
        <br />
        <div className="flex flex-col md:flex-row items-center justify-center gap-11">
          ...
          <ul className="space-y-3 text-center md:text-left">
            <li className="flex items-center">
              <FaUserTie className="mr-3 text-xl text-gray-700" />
              <span className="text-lg">Name: {corporatorInfo.name}</span>
            </li>
            <hr />
            <li className="flex items-center">
              <FaBalanceScale className="mr-3 text-xl text-gray-700" />
              <span className="text-lg">Party: {corporatorInfo.party}</span>
            </li>
            <hr />
            <li className="flex items-center">
              <FaClock className="mr-3 text-xl text-gray-700" />
              <span className="text-lg">Tenure: {corporatorInfo.tenure}</span>
            </li>
            <hr />
            <li className="flex items-center">
              <FaMoneyBillWave className="mr-3 text-xl text-gray-700" />
              <span className="text-lg">Budget: {corporatorInfo.budget}</span>
            </li>
            <hr />
            <li className="flex items-center">
              <FaMoneyBillWave className="mr-3 text-xl text-gray-700" />
              <span className="text-lg">Income: {corporatorInfo.income}</span>
            </li>
            <br /><br />
          </ul>
          <br />
          ...
          {oppositionCorporators.map((opponent, index) => (
            ...
            >
              ...
              <div className="mt-12 text-center">
                <p className="text-lg font-semibold pt-8">{opponent.name}</p>
